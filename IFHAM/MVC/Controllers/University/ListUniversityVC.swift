...
class ListUniversityVC: BaseAndMenuVC {

    @IBOutlet weak var colUniversity: UICollectionView!
    ...
    func initView() {
        ...
        colUniversity.dataSource = self
        colUniversity.delegate = self
        colUniversity.reloadData()
    ...
    func loadData() {
        ...
        APIManager.shared.getUniData { (result_code, msg, data) in
            self.hideLoadingView()
            if result_code == CONSTANT.CODE_SUCCESS {
                
                self.dataSource = data as! [CategoryModel]
                self.colUniversity.reloadData()
            } else {
...
extension ListUniversityVC: UICollectionViewDelegate {
...
extension ListUniversityVC : UICollectionViewDataSource {
...
extension ListUniversityVC : UICollectionViewDelegateFlowLayout {
